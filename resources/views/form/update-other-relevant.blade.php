...
<div class="container">
    ...
    <div class="row" style="margin-top: 80px;">
        <div class="col-md-6 offset-md-3">
            ...
            <form action="{{url('/update-other-relevant')}}" method="POST">
...
<br>
                <fieldset>
                    <legend>Other Relevant Information</legend>
                        <input type="text" name="personal_id" hidden value="{{$other -> personal_id}}">
                    
                    <div class="form-group">
                        <label for="first-name">Skills and Certifications <span>*</span></label>
                        <input type="text" name="skills_certificate" required placeholder="Enter Skills and Certifications" value="{{$other -> skills_certificate}}">
                    ...
                    <div class="form-group">
                        ...
                        <select name="availability">
                            <option selected>{{$other -> availability}}</option>
