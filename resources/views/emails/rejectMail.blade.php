...
<img src="../assets/images/Asset4@4x.png" alt="Dernan">

<h3 style="font-size: 20px;">Dear {{ $applicant -> first_name }} {{ $applicant -> middle_name }} {{ $applicant -> last_name }}</h3>
<hr>
<p>Thank you for your interest in the {{ $applicant -> position }} role at Dernan Salt Limited and for taking the time to apply.
